  ...
  async process(job: Job<any, any, string>): Promise<any> {
    ...
    if (mimeType && mimeType.startsWith('image/')) {
      try {
        ...
        await this.storageService.uploadFile(thumbKey, thumbnailBuffer, 'image/jpeg');
      ...
      this.logger.log(`Skipping thumbnail generation for non-image file ${fileId} (${mimeType})`);
    }
